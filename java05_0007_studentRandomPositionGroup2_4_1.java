...
public class java05_0007_studentRandomPositionGroup2_4_1 {
...
//        // 1) 배열의 위치를 바꾸는 코드를 구현하되, 배열의 길이가 얼마가 되든
          ...
          if(finderNum == 0) {
        	  ...
        	  switchArray(positionArray.size()-1,"권지혜");
          }else {
   ...
   private static void switchArray(int seatNum, String name) {
    
     	  positionArray.set(0,positionArray.get(seatNum));
     	  positionArray.set(seatNum,name);
   }
